    ...
    : SystemParam(ParameterName, Index)
{
    ...
    public override string TypeSignatureId => "Query_" + StructType.Replace("global::", "").Replace(".", "_");
    public override string GenerateArgumentCode() => $"new global::TECS.Query.Query<{StructType}>(ecs)";
    public override string? GetReadsCode() => $"readsList.AddRange({StructType}Extensions.GetReads);";
    public override string? GetWritesCode() => $"writesList.AddRange({StructType}Extensions.GetWrites);";
}
    ...
    : SystemParam(ParameterName, Index)
{
    ...
    public override string TypeSignatureId => "EventReader_" + EventType.Replace("global::", "").Replace(".", "_");
    public override string? GenerateSetupCode() => $"var reader_{Index} = ecs.GetEventReader<{EventType}>();";
    ...
    : SystemParam(ParameterName, Index)
{
    ...
    public override string TypeSignatureId => "EventWriter_" + EventType.Replace("global::", "").Replace(".", "_");
    public override string? GenerateSetupCode() => $"var writer_{Index} = ecs.GetEventWriter<{EventType}>();";
    ...
    : SystemParam(ParameterName, Index)
{
    ...
    public override string TypeSignatureId => "Res_" + ResourceType.Replace("global::", "").Replace(".", "_");
    public override string? GenerateSetupCode() => $"var res_{Index} = new global::TECS.Query.Res<{ResourceType}> {{ Value = ecs.GetResource<{ResourceType}>() }};";
    ...
    : SystemParam(ParameterName, Index)
{
    ...
    public override string TypeSignatureId => "ResMut_" + ResourceType.Replace("global::", "").Replace(".", "_");
    public override string? GenerateSetupCode() => $"var resMut_{Index} = new global::TECS.Query.ResMut<{ResourceType}> {{ Value = ecs.GetTResourceMut<{ResourceType}>() }};";
