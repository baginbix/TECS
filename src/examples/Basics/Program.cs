...
public static class GameSystems
{
    ...
    public static void SetUp(CommandBuffer cmd)
    {
        ...
        cmd.AddComponent(bullet, new Position { X = 0, Y = 0 });
        cmd.AddComponent(bullet, new Velocity { X = 10, Y = 0 }); // Moves right by 10
        cmd.AddComponent(bullet, new Health { Hp = 100 });
        ...
        Entity rock = cmd.CreateEntity();
        cmd.AddComponent(rock, new Position { X = 100, Y = 100 });
    }
